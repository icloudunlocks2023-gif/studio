...
export default function ContactPage() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      link: 'https://wa.me/message/VAWM7QDYEPBZF1'
    },
    {
      lucideIcon: Mail,
      title: 'Email Support',
  ...
  return (
    <div className="bg-background text-foreground flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link href="/contact" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors px-3 py-2 rounded-md text-sm font-medium ring-1 ring-inset ring-primary">Contact</Link>
                ...
                <SheetContent side="right">
                  ...
                  <div className="flex flex-col gap-4 p-4">
                    ...
                    {isAdmin && (
                     ...
                     <Link href="/contact" className="text-gray-700 dark:text-gray-300 hover:text-primary py-2 rounded-md text-base font-medium transition-colors ring-1 ring-inset ring-primary">Contact</Link>
                    <div className='pt-4'>
                      <LoginButton />
                    </div>
                  </div>
      ...
      <main className="max-w-4xl mx-auto pt-24 pb-12 px-4 sm:px-6 lg:px-8 flex-grow">
        <Card className="bg-card p-8 md:p-12 rounded-2xl shadow-lg border border-border">
          <CardHeader className="text-center p-0 mb-8">
            <CardTitle className="text-4xl font-bold text-foreground">Get in Touch</CardTitle>
