...
function MyAccountContent() {
  ...
  const additionalMethods = [
    ...
    { id: 'usdc-erc20', name: 'USDC (ERC20)', icon: usdcImage, address: '0x14f7B2e7EaB06Af1Adab71d05d80649EBcb65692', type: 'crypto' },
    { id: 'eth', name: 'Ethereum (ETH)', icon: ethImage, address: '0x14f7B2e7EaB06Af1Adab71d05d80649EBcb65692', type: 'crypto' },
